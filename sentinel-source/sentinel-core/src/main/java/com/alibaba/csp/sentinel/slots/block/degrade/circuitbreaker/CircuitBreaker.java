 ...
 * @author Eric Zhao
 *
 * sentinel 1.8 中，将三种熔断策略（慢调用、异常比例、异常数）封装为两种熔断器：
 * 1. ResponseTimeCircuitBreaker：响应时间熔断器
 * 2. ExceptionCircuitBreaker：异常熔断器
 */
public interface CircuitBreaker {
     ...
     * State：
     * 1.OPEN：打开状态，会拒绝所有请求
     * 2.HALF_OPEN：半开状态(过渡状态)，
     * 3.CLOSED：关闭状态，所有请求可以通过
     *
